...
final class LoginView: UIView {
    ...
    lazy var passwordlLabel: UILabel = {
        ...
        label.text = "Пароль должен содержать не менее восьми знаков, включать буквы, цифры."
        label.textAlignment = .center
    ...
    private func addSubviews() {
        [titleLabel, emailTextField, passwordTextField, passwordlLabel, loginButton, registrationButton, activityIndicationView]
            .forEach {
                addSubview($0)
